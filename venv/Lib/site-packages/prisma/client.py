...
SCHEMA_PATH = Path('E:/My_Code/AIDebugCopilot/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\zk039\\.cache\\prisma-python\\binaries\\5.11.0\\efd2449663b3d73d637ea1fd226bafbcf45b3102\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    debugsession: 'actions.DebugSessionActions[models.DebugSession]'
    message: 'actions.MessageActions[models.Message]'
    debugresult: 'actions.DebugResultActions[models.DebugResult]'
    ...
    def __init__(
        ...
        *,
        ...
        self.debugsession = actions.DebugSessionActions[models.DebugSession](self, models.DebugSession)
        self.message = actions.MessageActions[models.Message](self, models.Message)
        self.debugresult = actions.DebugResultActions[models.DebugResult](self, models.DebugResult)
...
class Batch:
    debugsession: 'DebugSessionBatchActions'
    message: 'MessageBatchActions'
    debugresult: 'DebugResultBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.debugsession = DebugSessionBatchActions(self)
        self.message = MessageBatchActions(self)
        self.debugresult = DebugResultBatchActions(self)
...
class DebugSessionBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.DebugSessionCreateInput,
        include: Optional[types.DebugSessionInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.DebugSession,
            arguments={
                'data': data,
                'include': include,
            },
    ...
    def create_many(
        self,
        data: List[types.DebugSessionCreateWithoutRelationsInput],
        *,
    ...
    def delete(
        self,
        where: types.DebugSessionWhereUniqueInput,
        include: Optional[types.DebugSessionInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.DebugSessionUpdateInput,
        where: types.DebugSessionWhereUniqueInput,
        include: Optional[types.DebugSessionInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.DebugSessionWhereUniqueInput,
        data: types.DebugSessionUpsertInput,
        include: Optional[types.DebugSessionInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.DebugSessionUpdateManyMutationInput,
        where: types.DebugSessionWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.DebugSession,
    ...
    def delete_many(
        self,
        where: Optional[types.DebugSessionWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.DebugSession,
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class DebugResultBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.DebugResultCreateInput,
        include: Optional[types.DebugResultInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.DebugResult,
            arguments={
                'data': data,
                'include': include,
            },
    ...
    def create_many(
        self,
        data: List[types.DebugResultCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if self._batcher._active_provider == 'sqlite':
    ...
    def delete(
        self,
        where: types.DebugResultWhereUniqueInput,
        include: Optional[types.DebugResultInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.DebugResultUpdateInput,
        where: types.DebugResultWhereUniqueInput,
        include: Optional[types.DebugResultInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.DebugResultWhereUniqueInput,
        data: types.DebugResultUpsertInput,
        include: Optional[types.DebugResultInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.DebugResultUpdateManyMutationInput,
        where: types.DebugResultWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.DebugResult,
    ...
    def delete_many(
        self,
        where: Optional[types.DebugResultWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.DebugResult,
